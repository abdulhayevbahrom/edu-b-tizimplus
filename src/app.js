...
app.use(async (_req, res, next) => {
  try {
    ...
    return res
      .status(503)
      .json({ message: "Ma’lumotlar bazasiga ulanib bo‘lmadi" });
  }
});
...
app.use(
  "/api/dashboard",
  authenticate,
  requireAnyPermission("dashboard"),
  dashboardRouter,
);
...
app.use(
  "/api/teachers",
  authenticate,
  requireAnyPermission("teachers", "groups"),
  teachersRouter,
);
app.use(
  "/api/groups",
...
app.use(
  "/api/leads",
  authenticate,
  requireAnyPermission("reception", "students", "groups"),
  leadsRouter,
);
app.use(
  "/api/students",
  authenticate,
  requireAnyPermission("students", "reception", "groups"),
  studentsRouter,
);
app.use(
  "/api/attendance",
...
app.use(
  "/api/finance",
  authenticate,
  requireAnyPermission("payments", "students"),
  financeRouter,
);
app.use(
  "/api/expenses",
  authenticate,
  requireAnyPermission("expenses"),
  expensesRouter,
);
app.use(
  "/api/users",
  authenticate,
  requireAnyPermission("employees"),
  usersRouter,
);
app.use(
  "/api/reports",
  authenticate,
  requireAnyPermission("dashboard", "payments", "expenses"),
  reportsRouter,
);
