...
app.use('/api/leads', authenticate, requireAnyPermission('reception', 'students', 'groups'), leadsRouter);
app.use('/api/students', authenticate, requireAnyPermission('students', 'reception', 'groups'), studentsRouter);
app.use('/api/attendance', authenticate, requireAnyPermission('students', 'reception', 'groups'), attendanceRouter);
